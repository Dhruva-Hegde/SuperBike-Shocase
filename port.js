...
const bikeData = {
  "Yamaha R1M": {
    ...
    description:
      "The Yamaha YZF-R1 is a high-performance superbike featuring cutting-edge technology from MotoGP.",
  ...
  "Ducati Panigale V4": {
    ...
    description:
      "The Ducati Panigale V4 is an Italian masterpiece, offering extreme performance and stunning design.",
  ...
  "Kawasaki Ninja H2": {
    ...
    description:
      "The Ninja H2 is a supercharged beast, designed for high-speed performance and ultimate thrill.",
  ...
  "BMW S1000RR": {
    ...
    description:
      "BMW’s S1000RR is a race-inspired superbike with a powerful engine and lightweight frame.",
  ...
  "Suzuki Hayabusa": {
    ...
    description:
      "The Suzuki Hayabusa is a legendary hyperbike known for its high speed and comfortable ride.",
  ...
  "Honda CBR1000RR-R": {
    ...
    description:
      "Honda's CBR1000RR-R Fireblade offers precision handling, power, and aerodynamics inspired by MotoGP.",
  },
  "Aprilia RSV4 1100": {
    img: "Aprilia RSV4 1100.jpg",
    specs: "1099cc, 217HP, 305km/h",
    description:
      "The Aprilia RSV4 1100 is an Italian superbike with top-tier technology and exceptional performance.",
  ...
  "MV Agusta F4": {
    ...
    description:
      "MV Agusta's F4 is a stunning superbike known for its aggressive styling and impressive speed.",
  ...
  "KTM RC 8C": {
    ...
    description:
      "The KTM RC 8C is a lightweight track weapon, built for precision and agility.",
  ...
  "Triumph Daytona 765": {
    ...
    description:
      "Triumph’s Daytona 765 offers a perfect balance of speed, handling, and power.",
  ...
  "Yamaha MT-10": {
    ...
    description:
      "The Yamaha MT-10 is a naked powerhouse with an aggressive design and exhilarating performance.",
  ...
  "Ducati Streetfighter V4": {
    ...
    description:
      "Ducati's Streetfighter V4 is a hyper-naked beast delivering raw power with a striking look.",
  ...
  "Kawasaki ZX-10R": {
    ...
    description:
      "The Kawasaki ZX-10R is a championship-winning superbike packed with advanced technology.",
  ...
  "BMW M1000RR": {
    ...
    description:
      "The BMW M1000RR is a high-performance track bike with aerodynamics optimized for speed.",
  ...
  "Suzuki GSX-R1000": {
    ...
    description:
      "Suzuki’s GSX-R1000 is a well-balanced superbike with a legacy of racing success.",
  ...
  "Honda Fireblade SP": {
    ...
    description:
      "The Fireblade SP combines Honda's engineering excellence with track-inspired aerodynamics.",
  },
  "Aprilia Tuono V4": {
    img: "Aprilia Tuono V4.jpg",
    specs: "1077cc, 175HP, 280km/h",
    description:
      "The Aprilia Tuono V4 is a high-performance naked bike with track-ready capabilities.",
  ...
  "MV Agusta Brutale 1000 RR": {
    ...
    description:
      "MV Agusta’s Brutale 1000 RR is an aggressive, high-performance naked sportbike.",
  ...
  "KTM 1390 Super Duke R": {
    ...
    description:
      "KTM’s 1390 Super Duke R is a streetfighter with immense power and torque.",
  ...
  "Triumph Speed Triple 1200 RR": {
    ...
    description:
      "The Speed Triple 1200 RR is a café racer-styled superbike with modern-day performance.",
  ...
  "Yamaha R7": {
    ...
    description:
      "The Yamaha R7 is a middleweight sportbike offering a blend of power and agility.",
  ...
  "Ducati Monster 1200": {
    ...
    description:
      "The Ducati Monster 1200 is a powerful yet comfortable naked bike with Italian styling.",
...
function showDetails(bikeName) {
  ...
  if (bike) {
    ...
    document.getElementById(
      "bike-link"
    ).innerHTML = `<a href="${bike.link}" target="_blank">More Details</a>`;
...
/**
 * @type {AudioBufferSourceNode | null} - currentAudio
 */
...
function playSound(event, soundFile) {
  ...
  fetch(soundFile)
    ...
    .then((decodedAudio) => {
      ...
      currentAudio.buffer = decodedAudio;
      currentAudio.connect(audioContext.destination);
      currentAudio.start();

      // Automatically stop the audio after 15 seconds
      timeout = setTimeout(() => {
        stopSound();
      }, 15000);
    })
...
document.body.addEventListener("click", () => {
  requestAnimationFrame(stopSound);
});
